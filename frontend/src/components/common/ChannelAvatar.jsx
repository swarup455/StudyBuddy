...
const ChannelAvatar = ({ channel }) => {
    ...
    return (
        <div className={`w-full aspect-square text-white flex justify-center items-center rounded-full bg-gradient-to-br ${getColorClass(channel.channelName)} overflow-hidden`}>
            {channel.channelLogo ?
